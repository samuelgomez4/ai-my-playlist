...
export function FeatureCard({ feature }: Props) {
  ...
  return (
    <article className="bg-gray-800 rounded-xl p-6 transform hover:scale-105 transition-all duration-300 shadow-xl">
      <div className="flex flex-col items-center">
        ...
        <p className="text-gray-400 text-center mb-4 text-pretty max-w-prose">{description}</p>
